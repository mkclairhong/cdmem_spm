function AnaDef = item_glm_batch(subjID)
...
AnaDef.fmri_t               = 16;
AnaDef.fmri_t0              = 9;
AnaDef.OutDir               = 'betaItem';  % output directory
...
AnaDef.Outfile              = ['/scratch/polynlab/fmri/cdcatmr/cdcatmr', subj, '/model/out_single_est.mat'];
...
for i=1:length(vp)
    ...
    AnaDef.Subj{cSubj}.Onsets   = {'onsets_1.csv','onsets_2.csv','onsets_3.csv','onsets_4.csv','onsets_5.csv','onsets_6.csv','onsets_7.csv','onsets_8.csv',};
