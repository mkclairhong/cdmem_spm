function pats = beta2pat(subjID)
% for single subject, single mask (specify mask directory roi_mask below)

addpath(genpath('/home/jeonj1/matlab/spm12'))
roi_mask = '/scratch/polynlab/fmri/cdcatmr/all_subjects/masks/resliced/rTemporal_Mid_lr.nii';
...
saveDir = [subjDir, '/images/pattern/'];
